...
const Hero = () => {
  return (
    <section className="hero py-12 w-full bg-background">
      <div className="cont">
        <div className="flex w-full h-full items-center justify-center">
          <div className="flex-1">
            ...
            <div className="hero-buttons flex items-center gap-4 mt-4">
              <Button className="text-white button">Get-Started</Button>
